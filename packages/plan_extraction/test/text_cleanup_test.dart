...
void main() {
  ...
  group("the header and footer a browser prints on a page that is the whole "
    ...
    test('a date-and-time line survives when nothing corroborates it as a '
        "browser's header", () {
      ...
      final out = clean([
        ['27/8/2026, 09:00', 'Day 1 - Rome', '13:00 Lunch in Monti'],
      ]);
      expect(out, contains('27/8/2026, 09:00'));
    });

    test("the same date-and-time line goes once the page's own web-address "
