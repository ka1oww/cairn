...
/// web. 48 bits keeps every step of the arithmetic exact on every backend
/// (VM, AOT, and web) while still giving ~2.8e14 distinct buckets, far
/// more than enough resolution for scheduling a time of day.
///
...
/// changed after the app has shipped.
