...
void main() {
  group('area ground truth C7t', () {
    ...
    test('aggregate floors', () {
      ...
      print(
          'C7t aggregate: correct=$aggCorrect wrong=$aggWrong miss=$aggMiss noneOk=$aggNoneOk rowsOK=${rowsOk.toStringAsFixed(1)}%');
      print('needs-area correct=$needsAreaCorrect wrong=$needsAreaWrong');
      print(
          'doc01 correct=$doc01Correct wrong=$doc01Wrong doc05 wrong=$doc05Wrong');

      // Pinned floors per plan §8.2 (C7t): 170/19/87.5%.
      expect(aggCorrect, greaterThanOrEqualTo(170),
          reason: 'aggregate correct floor');
      expect(aggWrong, lessThanOrEqualTo(19),
          reason: 'aggregate wrong ceiling');
      expect(rowsOk, greaterThanOrEqualTo(87.5),
          reason: 'aggregate rowsOK floor');
      // Needs-area subset (74 rows where NONE absent)
      expect(needsAreaCorrect, greaterThanOrEqualTo(60),
