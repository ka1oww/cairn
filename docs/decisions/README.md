...
| [2026-08-27 — the former phone clock](2026-08-27-the-trip-clock-is-the-phones.md) | Superseded by the destination clock decision; preserves the original sync-standing and unnamed-trip work |
| [2026-09-03 — the two-minute window](2026-09-03-the-two-minute-window.md) | The window narrows to two minutes, retakes become unlimited against the one deadline a moment has, late stays late, and the tail is retuned rather than collapsed |
| [2026-09-08 — the destination clock](2026-09-08-the-trip-clock-is-the-destination.md) | Supersedes the phone clock: the destination's persisted IANA zone reads every day, including DST; unknown stays quiet rather than pretending it is the phone |
