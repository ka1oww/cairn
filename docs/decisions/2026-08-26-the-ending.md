...
| The plan cannot be replaced | `PasteFlow.accept` | the phone owns the plan's shape, but since `0016`/`0017` a closed trip's plan takes no write at all, on any of its four tables: `guard_closed_trip_itinerary_write` |
