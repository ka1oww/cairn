...
- **The shared facts' sync is live on an ordinary build — since 27 August 2026
  ...
  hosted project — only the permitted paths. The 165 adversarial checks still
